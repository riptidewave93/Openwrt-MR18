...
void ap91_dual_pci_init(u8 *cal_data0, u8 *mac_addr0,
		   u8 *cal_data1, u8 *mac_addr1);
void ap91_pci_init_simple(void);
void ap91_dual_pci_init_simple(void);
...
static inline void ap91_dual_pci_init(u8 *cal_data0, u8 *mac_addr0,
				 u8 *cal_data1, u8 *mac_addr1) {}
static inline void ap91_pci_init_simple(void) {}
static inline void ap91_dual_pci_init_simple(void) {}
